...
class ProgressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create progress" do
    assert_difference('Progress.count') do
      post progresses_url, params: { progress: { goal_id: @progress.goal_id, value: @progress.value } }
    end
  ...
  test "should update progress" do
    patch progress_url(@progress), params: { progress: { goal_id: @progress.goal_id, value: @progress.value } }
